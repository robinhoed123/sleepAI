...
class LifeStyleAI(ctk.CTk):
    ...
    def create_test_ai_screen(self):
        ...
        form_frame.pack(pady=20, padx=100, fill="both")
        ...
        gender_frame.pack(pady=15, fill="x")
        ...
        sleep_frame.pack(pady=15, fill="x")
        ...
        exercise_frame.pack(pady=15, fill="x")
        ...
        caffeine_frame.pack(pady=15, fill="x")
        ...
        screen_frame.pack(pady=15, fill="x")
        ...
        work_frame.pack(pady=15, fill="x")
        ...
        # Results will be populated here when the calculate button is clicked
    ...
    def create_visualize_screen(self):
        ...
        # Visualization buttons - these don't do anything yet
        sleep_button = self.create_button(self.visualize_frame, "Sleep and Productivity", 
                                         lambda: None, font_size=20, width=400, height=60)
        sleep_button.pack(pady=15)
        
        exercise_button = self.create_button(self.visualize_frame, "Exercise and Mood", 
                                            lambda: None, font_size=20, width=400, height=60)
        exercise_button.pack(pady=15)
        
        caffeine_button = self.create_button(self.visualize_frame, "Caffeine and Stress", 
                                            lambda: None, font_size=20, width=400, height=60)
        caffeine_button.pack(pady=15)
        
        screen_button = self.create_button(self.visualize_frame, "Screen Time and Sleep Quality", 
                                          lambda: None, font_size=20, width=400, height=60)
        screen_button.pack(pady=15)
        
        work_button = self.create_button(self.visualize_frame, "Work Hours and Stress", 
                                        lambda: None, font_size=20, width=400, height=60)
        work_button.pack(pady=15)
        
        gender_button = self.create_button(self.visualize_frame, "Gender Distribution", 
                                          lambda: None, font_size=20, width=400, height=60)
        gender_button.pack(pady=15)
        
        age_button = self.create_button(self.visualize_frame, "Age Distribution", 
                                       lambda: None, font_size=20, width=400, height=60)
    ...
    def show_results(self):
        ...
        productivity_frame.pack(pady=15, fill="x")
        ...
        mood_frame.pack(pady=15, fill="x")
